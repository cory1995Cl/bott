...
def abrir_combat_interfaz():
    """Abre la interfaz de combate ejecutando el archivo combat_interfaz.py"""
    subprocess.Popen(['python', 'combat_interfaz.py'])
...
def main():
    ...
    # Botón para abrir la interfaz de combate
    boton_combat = tk.Button(ventana, text="Combat", command=abrir_combat_interfaz, bg="lightcoral", font=("Arial", 12))
    boton_combat.pack(pady=10)  
